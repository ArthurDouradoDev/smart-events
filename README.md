...
- **Gráfico de KPIs Reativo com Seleção de Célula**: Exibição em linha temporal (Chart.js) das principais métricas das ERBs do site selecionado. O seletor de célula integrado permite visualizar o comportamento de uma célula individual, a curva média ou os valores consolidados de todo o site, exibindo linhas de threshold (limiares de alerta) e realce de períodos sem coleta de dados (gaps de tempo > 90 segundos).
